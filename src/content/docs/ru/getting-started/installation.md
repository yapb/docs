...
:::note
Существует неофициальный бинарный файл `hlds_osx`, предоставленный AlliedModders LLC, позволяющий вам запускать HLDS под macOS. Вы можете попробовать скачать его [отсюда](https://forums.alliedmods.net/showpost.php?p=2041538&postcount=11).
