...
Указывает URL-адрес, с которого боты смогут скачать граф при отсутствии локального. Принимает полный базовый URL со схемой (рекомендуется https) или устаревшее bare-имя хоста (подразумевается http). Установите пустое значение, если скачивание не нужно.

| Свойство | Значение |
|----------|----------|
| По умолчанию | `https://raw.githubusercontent.com/yapb/graph/refs/heads/master` |
