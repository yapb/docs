...
:::note
Некоторые типы узлов всегда имеют и требуют радиус, равный нулю. Радиус этих типов узлов **НЕ должен изменяться!** Типы с фиксированным радиусом: Лестница, Спасение, Кемпинг (независимо от того, для конкретной команды или нет) и Цель карты.
:::
...
:::note
Если вы создали исходящее путевое соединение от узла A к узлу B, оно будет отображаться белым цветом. И когда вы дойдёте до узла B, путевое соединение станет бирюзовым, как входящее путевое соединение.
:::
...
:::note
Это работает только если вы стоите рядом с узлом и направляете прицел на другой! Если вы стоите в области без узлов, вы не сможете использовать эту функцию, потому что она требует двух выбранных узлов (того, на котором вы стоите, и того, на который вы направляете прицел)!
:::
...
![Меню флагов узлов](../images/waypoint_flags_menu.png)
