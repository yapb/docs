...
Вот и всё! Если вы не хотите сделать узел кемпинга специфичным для команды или добавить другой флаг (см.: [Флаги узлов](\/docs\/ru/waypointing/connections-and-flags/)), вы закончили! На самом деле это звучит намного сложнее, чем есть на самом деле.
