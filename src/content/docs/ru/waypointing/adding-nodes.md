...
![Меню редактора графов (Страница 1)](../images/waypoint_menu_page1.png)
...
![Меню типов узлов](../images/waypoint_type_menu.png)
...
:::note
Если вы стоите при выборе узла, будет поставлен стоячий узел. Все боты будут бежать или идти к этому узлу как обычно. Если вы хотите, чтобы боты приседали при приближении к определённой позиции, присядьте во время установки узла. Вы заметите, что только что добавленный узел примерно вдвое ниже, чем обычно. Когда вы поставили его, сидя на корточках, на нём автоматически отобразится флаг **Crouch** (см.: [Типы узлов](\/docs\/ru/waypointing/node-types/)). Боты теперь будут автоматически приседать при попытке достичь этого узла.
:::
